 ...
 * @since 2013.10.06
 */
public abstract class SmartIOIOActivity<AggregateClass>
    extends IOIOActivity
    implements Smartable<AggregateClass>
{

  private final Droid4mizer<AggregateClass, Smartable<AggregateClass>> droid4mizer = new Droid4mizer<AggregateClass, Smartable<AggregateClass>>(this, this, this, null);
  ...
  protected void onCreate(final Bundle savedInstanceState)
  {
    droid4mizer.onCreate(new Runnable()
    {
      public void run()
      {
        SmartIOIOActivity.super.onCreate(savedInstanceState);
      }
    }, savedInstanceState);
  }
